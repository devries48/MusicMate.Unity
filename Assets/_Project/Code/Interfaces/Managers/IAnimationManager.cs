...
namespace Interfaces.Managers
{
    ...
    public interface IButtonAnimations
    {
        ...
        void PlayClicked(TabItemAnimator tabItem);
        void PlayHoverEnter(TabItemAnimator tabItem);
        void PlayHoverExit(TabItemAnimator tabItem);
    }
    ...
    public interface IInputAnimations
    {
        ...
        void PlayListItemNormal(TextMeshProUGUI label, Image background, bool isSelected = false, Image arrow = null);
        void PlayListItemHighlight(TextMeshProUGUI label, Image background, bool isSelected = false, Image arrow = null);
    }
    ...
    public interface IPanelAnimations
    {
        ...
        void PlayCollapseAudioPlayer(RectTransform largePlayer, RectTransform smallPlayer, bool delay = false,
            Action onComplete = null);

        void PlayExpandAudioPlayer(RectTransform expandedPlayer, RectTransform collapsedPlayer, bool delay = false,
            Action onComplete = null);
