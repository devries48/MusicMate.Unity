...
{
    private static readonly List<(string Code2, string Code3, string Name)> Countries = new()
{("AD", "AND", "Andorra"),
    ...
    public static int GetFlagIndex(string countryCode)
    {
        if (string.IsNullOrWhiteSpace(countryCode))
            throw new ArgumentException("Country code cannot be null or empty.", nameof(countryCode));

        countryCode = countryCode.ToUpperInvariant();
        int index = Countries.FindIndex(c => c.Code2 == countryCode || c.Code3 == countryCode);
